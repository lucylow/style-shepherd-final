...
- Personalized outfit recommendations based on body type, style preferences, and occasion
- Size recommendations to reduce return rates
- Style advice and fashion trends
- Product fit analysis and sizing guidance
- Answering questions about fabrics, care instructions, and styling tips

Be helpful, concise, and focus on reducing returns by ensuring perfect fit and style match.`;
    ...
    console.error("Fashion assistant error:", error);
    return new Response(
